...
class AffinityGraphConfig:
    """Graph construction for ``AffinityGraphEnv``.
    ...
    # Baseline cut denominators for |Δr|, |Δk| scalars (defaults = spatial–momentum cuts).
...
class AffinityGraphEnv:
    ...
    :func:`models.baseline.compute_event_baseline`.
